...
export class FakeData {
  ...
  private readonly allUsers: User[] = [
    new User("fake-user-001", "Allen", "Anderson", "@allen", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-002", "Amy", "Ames", "@amy", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-003", "Bob", "Bobson", "@bob", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-004", "Bonnie", "Beatty", "@bonnie", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-005", "Chris", "Colston", "@chris", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-006", "Cindy", "Coats", "@cindy", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-007", "Dan", "Donaldson", "@dan", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-008", "Dee", "Dempsey", "@dee", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-009", "Elliott", "Enderson", "@elliott", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-010", "Elizabeth", "Engle", "@elizabeth", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-011", "Frank", "Frandson", "@frank", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-012", "Fran", "Franklin", "@fran", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-013", "Gary", "Gilbert", "@gary", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-014", "Giovanna", "Giles", "@giovanna", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-015", "Henry", "Henderson", "@henry", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-016", "Helen", "Hopwell", "@helen", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-017", "Igor", "Isaacson", "@igor", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-018", "Isabel", "Isaacson", "@isabel", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-019", "Justin", "Jones", "@justin", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-020", "Jill", "Johnson", "@jill", FEMALE_IMAGE_URL, 0, 0),
    new User("fake-user-021", "Kent", "Knudson", "@kent", MALE_IMAGE_URL, 0, 0),
    new User("fake-user-022", "Kathy", "Kunzler", "@kathy", FEMALE_IMAGE_URL, 0, 0),
  ];
   ...
   */
  public getFollowerCount(alias: string): number | PromiseLike<number> {
   ...
   */
  public getFolloweeCount(alias: string): number | PromiseLike<number> {
    return Math.floor(Math.random() * 10) + 1;
  }
}
